...
positive definite function, e.g.

$$\sigma_f^2 \exp\left(\frac{(x_i - x'_j)^2}{2 l^2} \right).$$

A positive definite function is a function $f:\mathbb{R} \rightarrow \mathbb{C}$
such that for any $x_1, ..., x_n \in \mathbb{R}$, the matrix
$\Sigma = (f(x_i - x_j))_{i, j = 1}^n$ is positive semi-definite (there is an
alternative definition in dynamical systems).
