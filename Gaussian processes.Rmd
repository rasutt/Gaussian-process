...
$$K(\mathbf{x}, \mathbf{x}')_{i, j} = k(x_i, x_j') = \sigma_f^2 \exp\left(\frac{(x_i - x'_j)^2}{2 l^2} \right),$$

where $k(x, x')$ can be any positive semi-definite function, and is called the
