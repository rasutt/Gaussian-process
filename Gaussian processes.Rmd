...
For some reason too many samples with too large of a length scale gives an error in the Cholesky factorization of the covariance matrix.  Function sd makes no difference.

```{r}
# Plot samples from a GP
plot_samp(
  n_samp = 100, # Number of samples per realisation
