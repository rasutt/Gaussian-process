...
Placing a Gaussian prior on the weights of a Bayesian linear model that projects the inputs into a feature space with infinitely many basis functions $\phi(\mathbf{x}):\mathbb{R}^d \rightarrow \mathbb{R}$, defines a GP prior on the model function.  Taking observed input values as column vectors we have
